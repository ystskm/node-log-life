  ...
  function Life(filepath, options) {
    ...
    life.ready = Promise.resolve().then(function() {
      ...
      return new Promise(function(rsl, rej) {
        ...
        fs.open(fp, 'w+', function(er, fd) { er ? rej(er): rsl(life.fd = fd); })
      ...
      return new Promise(function(rsl, rej) { 
        ...
        fs.unlink(fp, function(er) { er ? rej(er): rsl(); });
        
      });
    }).then(function() {
      outLog('Planning successfully for: ' + fp);
    });
  ...
  function renewalStreams() {
    ...
    return Promise.resolve().then(function() {
      ...
      return new Promise(function(rsl, rej) {
        ...
        life.ws.end(new Date().toGMTString()  + ' - [LogLife] Close stream.', rsl);
  ...
  function createReadStream() {
    ...
    return Promise.resolve().then(function() {
      ...
      return new Promise(function(rsl, rej) {
        ...
        life.rs = fs.createReadStream(life.filepath, {
          fd: life.fd
        }).on('ready', rsl);
      ...
      case 'file':
      default:
        life.rs.on('readable', function() {
          
          // outLog('Readable stream is already readable!', life.rs);
          let data; while(data = life.rs.read()) { life.ws.write( data ); }
